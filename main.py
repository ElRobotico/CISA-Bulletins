...
# Requesting bulletin page and parsing
WEB_PAGE = input("URL of the page you want to export: ")
...
b = a[1].split("|")
FILENAME = "CISA Export " + b[0].strip() + ".csv"
...
with open(FILENAME, "w", encoding='UTF8', newline='') as f:
    ...
    for vuln in vulns:
        data_row = [vuln['product'], vuln['vendor'], vuln['description'],
                    vuln['published'], vuln['cvss'], vuln["cve"], vuln['reference']]
